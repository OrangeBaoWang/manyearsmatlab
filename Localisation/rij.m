...
function myRij = rijInit(myParameters, myMicrophones, myDelays, frameSize, ilterRange, resetRange)
% 	 /***************************************************************************
...
%     ***************************************************************************/
    myRij.delayMin=round(min(min(myDelays.lookup)) + 0.5);
    myRij.delayMax =round(max(max (myDelays.lookup))+0.5);
